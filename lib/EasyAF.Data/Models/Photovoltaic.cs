...
/// <summary>
/// Represents a Photovoltaic with comprehensive properties from EasyPower exports.
/// All properties are strings to preserve source data fidelity without premature parsing.
/// </summary>
/// <remarks>
/// <para>
/// <strong>EasyPower Correlation:</strong> Maps to "Photovoltaics" class in EasyPower CSV exports.
/// </para>
/// <para>
...
/// </para>
/// </remarks>
[EasyPowerClass("Photovoltaics")]
public class Photovoltaic
{
    /// <summary>Photovoltaics (Column: Photovoltaics)</summary>
    [Category("Identity")]
    [Description("Photovoltaics")]
    [Required]
    public string? Photovoltaics { get; set; }
    ...
    /// <summary>Max Pwr Rating (kW) (Column: Max Pwr Rating (kW))</summary>
    [Category("General")]
    [Description("Max Pwr Rating (kW)")]
    [Units("kW")]
    public string? MaxPwrRating { get; set; }

    /// <summary>Isc (A) (Column: Isc (A))</summary>
    [Category("General")]
    [Description("Isc (A)")]
    [Units("A")]
    public string? IscA { get; set; }

    /// <summary>kVoc (kV) (Column: kVoc (kV))</summary>
    [Category("Electrical")]
    [Description("kVoc (kV)")]
    [Units("kV")]
    public string? Kvoc { get; set; }

    /// <summary>kVmpp (kV) (Column: kVmpp (kV))</summary>
    [Category("Electrical")]
    [Description("kVmpp (kV)")]
    [Units("kV")]
    public string? Kvmpp { get; set; }
    ...
    /// <summary>Alias for Photovoltaic (convenience property for dictionary indexing - not serialized).</summary>
    [System.Text.Json.Serialization.JsonIgnore]
    [Newtonsoft.Json.JsonIgnore]
    public string? Id
    {
        get => Photovoltaics;
        set => Photovoltaics = value;
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="Photovoltaic"/> class.
    /// </summary>
    public Photovoltaic() { }

    /// <summary>
    /// Returns a string representation of the Photovoltaic.
    /// </summary>
