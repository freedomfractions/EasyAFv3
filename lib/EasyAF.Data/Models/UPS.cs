...
/// <summary>
/// Represents a UPS with comprehensive properties from EasyPower exports.
...
public class UPS
{
    ...
    public string? OneTwoCycleSC { get; set; }
    ...
    public string? ThreeZeroCycleSC { get; set; }
    ...
    public string? PercentEfficiency { get; set; }
    ...
    /// <summary>Alias for UPS (convenience property for dictionary indexing - not serialized).</summary>
