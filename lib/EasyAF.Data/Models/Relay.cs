...
public class Relay
{
    ...
    /// <summary>Tap (PA) (Column: Tap (PA))</summary>
    [Category("Control")]
    [Description("Tap (PA)")]
    [Units("PA")]
    public string? TapPA { get; set; }
    ...
    /// <summary>STPU Amps (PA) (Column: STPU Amps (PA))</summary>
    [Category("General")]
    [Description("STPU Amps (PA)")]
    [Units("PA")]
    public string? STPUAmpsPA { get; set; }
    ...
    /// <summary>Inst (PA) (Column: Inst (PA))</summary>
    [Category("General")]
    [Description("Inst (PA)")]
    [Units("PA")]
    public string? InstPA { get; set; }
    ...
    /// <summary>2 X Pickup (A) (Column: 2 X Pickup (A))</summary>
    [Category("General")]
    [Description("2 X Pickup (A)")]
    [Units("A")]
    public string? TwoXPickupA { get; set; }

    /// <summary>2 X Pickup (s) (Column: 2 X Pickup (s))</summary>
    [Category("General")]
    [Description("2 X Pickup (s)")]
    [Units("s")]
    public string? TwoXPickupSec { get; set; }

    /// <summary>5 X Pickup (A) (Column: 5 X Pickup (A))</summary>
    [Category("General")]
    [Description("5 X Pickup (A)")]
    [Units("A")]
    public string? FiveXPickupA { get; set; }

    /// <summary>5 X Pickup (s) (Column: 5 X Pickup (s))</summary>
    [Category("General")]
    [Description("5 X Pickup (s)")]
    [Units("s")]
    public string? FiveXPickupSec { get; set; }

    /// <summary>7 X Pickup (A) (Column: 7 X Pickup (A))</summary>
    [Category("General")]
    [Description("7 X Pickup (A)")]
    [Units("A")]
    public string? SevenXPickupA { get; set; }

    /// <summary>7 X Pickup (s) (Column: 7 X Pickup (s))</summary>
    [Category("General")]
    [Description("7 X Pickup (s)")]
    [Units("s")]
    public string? SevenXPickupSec { get; set; }
    ...
    /// <summary>Aux Time (cyc) (Column: Aux Time (cyc))</summary>
    [Category("General")]
    [Description("Aux Time (cyc)")]
    [Units("cyc")]
    public string? AuxTimeCyc { get; set; }
    ...
    /// <summary>Alias for Relay (convenience property for dictionary indexing - not serialized).</summary>
