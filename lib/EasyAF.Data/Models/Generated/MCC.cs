...
public class MCC
{
    ...
    /// <summary>Bus SC Rating (Column: Bus SC Rating (kA))</summary>
    [Category("Electrical")]
    [Description("Bus SC Rating")]
    [Units("kA")]
    public string? BusSCRating { get; set; }

    /// <summary>Horz Bus Rating (Column: Horz Bus Rating (A))</summary>
    [Category("Physical")]
    [Description("Horz Bus Rating")]
    [Units("A")]
    public string? HorzBusRating { get; set; }

    /// <summary>Vert Bus Rating (Column: Vert Bus Rating (A))</summary>
    [Category("Physical")]
    [Description("Vert Bus Rating")]
    [Units("A")]
    public string? VertBusRating { get; set; }

    /// <summary>MCC SC Rating (Column: MCC SC Rating (kA))</summary>
    [Category("Electrical")]
    [Description("MCC SC Rating")]
    [Units("kA")]
    ...
    /// <summary>X''dv or Xlr (Column: X''dv or Xlr (<50))</summary>
    [Category("General")]
    [Description("X''dv or Xlr")]
    [Units("<50")]
    public string? XdvorXlr { get; set; }
    ...
    /// <summary>Alias for MCCs (convenience property for dictionary indexing - not serialized).</summary>
