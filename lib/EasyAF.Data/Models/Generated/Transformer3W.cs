...
public class Transformer3W
{
    ...
    [Required]
    public string? Transformers3W { get; set; }
    ...
    /// <summary>Alias for Transformers3W (convenience property for dictionary indexing - not serialized).</summary>
    [System.Text.Json.Serialization.JsonIgnore]
    [Newtonsoft.Json.JsonIgnore]
    public string? Id
    {
        get => Transformers3W;
        set => Transformers3W = value;
    }
