...
public class Photovoltaic
{
    ...
    /// <summary>Max Pwr Rating (Column: Max Pwr Rating (kW))</summary>
    [Category("Electrical")]
    ...
    /// <summary>kVmpp (Column: kVmpp (kV))</summary>
    [Category("Electrical")]
    [Description("kVmpp")]
    [Units("kV")]
    ...
    /// <summary>Alias for Photovoltaics (convenience property for dictionary indexing - not serialized).</summary>
