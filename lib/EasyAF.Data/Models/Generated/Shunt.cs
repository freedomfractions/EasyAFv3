...
/// <summary>
/// Represents a Shunt with comprehensive properties from EasyPower exports.
/// All properties are strings to preserve source data fidelity without premature parsing.
/// </summary>
/// <remarks>
/// <para>
/// <strong>EasyPower Correlation:</strong> Maps to "Shunts" class in EasyPower CSV exports.
/// </para>
/// <para>
...
/// </para>
/// </remarks>
[EasyPowerClass("Shunts")]
public class Shunt
{
    /// <summary>Shunts (Column: Shunts)</summary>
    [Category("General")]
    [Description("Shunts")]
    [Required]
    ...
    /// <summary>jX (Column: jX)</summary>
    [Category("General")]
    [Description("jX")]
    public string? JX { get; set; }

    /// <summary>G pu (Column: G pu)</summary>
    [Category("General")]
    [Description("G pu")]
    public string? Gpu { get; set; }

    /// <summary>B pu (Column: B pu)</summary>
    [Category("General")]
    [Description("B pu")]
    ...
    /// <summary>Alias for Shunts (convenience property for dictionary indexing - not serialized).</summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Shunt"/> class.
    /// </summary>
    public Shunt() { }

    /// <summary>
    /// Returns a string representation of the Shunt.
    /// </summary>
