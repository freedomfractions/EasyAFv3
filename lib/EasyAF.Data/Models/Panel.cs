...
public class Panel
{
    ...
    /// <summary>Main Bus Rating (A) (Column: Main Bus Rating (A))</summary>
    [Category("Electrical")]
    [Description("Main Bus Rating (A)")]
    [Units("A")]
    public string? MainBusRatingA { get; set; }

    /// <summary>Panel SC Rating (kA) (Column: Panel SC Rating (kA))</summary>
    [Category("General")]
    [Description("Panel SC Rating (kA)")]
    [Units("kA")]
    ...
    /// <summary>Alias for Panel (convenience property for dictionary indexing - not serialized).</summary>
