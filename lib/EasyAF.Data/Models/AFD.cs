...
/// <summary>
/// Represents a AFD with comprehensive properties from EasyPower exports.
...
public class AFD
{
    ...
    /// <summary>Alias for AFD (convenience property for dictionary indexing - not serialized).</summary>
